...
import { Modal, View, Text, TextInput, TouchableOpacity, Image, ScrollView, KeyboardAvoidingView, Platform } from 'react-native';
...
const LoginPage = ({ isVisible, onClose }) => {
  ...
  return (
    <Modal
      animationType="fade" // Fade animation for full-screen effect
      transparent={true}
      visible={isVisible}
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
              <LinearGradient
                ...
                style={{ 
                  ...
                  borderRadius: 15, // Set border radius for the modal content
              ...
              >
                <LinearGradient
                  ...
                  style={{ flex: 1, borderRadius: 15, padding: 16 }}
                >
                  <View className="bg-opacity-80 rounded-t-lg p-6">
                    ...
                    <TouchableOpacity className="flex-row bg-[#A32979] rounded-lg p-4 items-center justify-center mb-5">
                      ...
                      />
                      <Text className="text-gray-200 text-lg ml-2">Login with Facebook</Text>
                    </TouchableOpacity>
                    <TouchableOpacity className="flex-row border-purple-900 border-2 rounded-lg p-4 items-center justify-center mb-2">
                      <Image
                        ...
                        className="w-6 h-6 mr-2"
                      />
                      <Text className="text-purple-900 text-lg ml-2">Login with Google</Text>
                    </TouchableOpacity>
                  </View>
                </LinearGradient>
              </LinearGradient>
